...
class WC_Memberships extends SV_WC_Plugin {
	...
	public function __call( $method, $args ) {
		...
		switch ( $method ) {
			...
			/** @deprecated since 1.6.0 */
			case 'add_endpoints' :
				_deprecated_function( 'wc_memberships()->add_endpoints()', $deprecated_since_1_6_0, 'wc_memberships()->get_members_area_instance()->add_endpoints()' );
			...
			/** @deprecated since 1.6.0 */
			case 'init_endpoints' :
				_deprecated_function( 'wc_memberships()->init_endpoints()', $deprecated_since_1_6_0, 'wc_memberships()->get_members_area_instance()' );
			...
			case 'get_members_area_template' :
				_deprecated_function( 'wc_memberships()->get_members_area_template()', $deprecated_since_1_6_0, 'wc_memberships()->get_frontend_instance()->get_members_area_instance()->get_template()' );
