									...
									case 'source' :
										...
										<td class="data">
											...
											<select name="<?php echo esc_attr( $options['id'] ); ?>[<?php echo esc_attr( $mapping_key ); ?>][source]" class="js-field-key wc-enhanced-select-nostd <?php echo $enhanced; ?>">
												<option value=""><?php esc_html_e( 'Select a value', 'woocommerce-customer-order-xml-export-suite' ); ?></option>
												<?php echo $html_field_options; ?>
												<option value="meta" <?php selected( 'meta', $value ); ?>><?php esc_html_e( 'Meta column...', 'woocommerce-customer-order-xml-export-suite' ); ?></option>
											</select>
