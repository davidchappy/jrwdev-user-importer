    ...
    class WC_Multiple_Shipping extends WC_Shipping_Method {
        ...
        public function inline_scripts() {
            ...
            if ( function_exists('wc_enqueue_js') ) {
                ...
                wp_add_inline_script( 'woocommerce_multi_shipping_init', $js );
            }
        ...
        function generate_ms_wp_editor_html( $key, $data ) {
            ...
            $html .= '<tr valign="top">' . "\n";
                ...
                if ( $tip )
                    $html .= '<img class="help_tip" data-tip="' . esc_attr( $tip ) . '" src="' . WC()->plugin_url() . '/assets/images/help.png" height="16" width="16" />';
